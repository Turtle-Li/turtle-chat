...
""",
    """\t\t<link rel="stylesheet" href="/static/custom.css?v=20260730.2" crossorigin="use-credentials" />
...
\t\t<script defer src="/static/turtle-storage-controls.js?v=20260730.2" crossorigin="use-credentials"></script>
""",
)
replace_once(
    index_path,
